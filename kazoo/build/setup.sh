...
apt-get -y --force-yes install erlang-dev vim curl wget git procps make python python3 build-essential zip unzip libexpat-dev unixodbc-dev libssh-4 libssh-dev libncurses5-dev autoconf
